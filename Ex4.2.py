# -*- coding: utf-8 -*-
"""Bản sao của Exercise 4.2 Changing optimization parameters.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YvF6HVcYiNLWdMwMgCoWxRVmSubPI51u
...
df = pd.read_csv("/titanic_all_numeric (1).csv")
...
for lr in lr_to_test:
    ...
    # Lấy một mô hình mới, chưa được huấn luyện để đảm bảo công bằng
    model = get_new_model()

    # Tạo một optimizer SGD với learning rate được chỉ định
    my_optimizer = SGD(learning_rate=lr)

    # Compile mô hình, lần này truyền vào optimizer object thay vì string
