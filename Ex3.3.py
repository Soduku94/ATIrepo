# -*- coding: utf-8 -*-
"""Bản sao của Exercise 3.3 Compiling and Fitting the model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oMj_qZXbkmP2R6pLFHpu1U4cayRSXqkE
...
# Set up the model: model (Giống hệt bài trước)
model = Sequential()
...
# Compile the model
# Đây là bước cấu hình quy trình học cho mô hình
model.compile(optimizer='adam', loss='mean_squared_error')

# Fit the model
# Đây là bước ra lệnh cho mô hình bắt đầu học từ dữ liệu
