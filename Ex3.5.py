# -*- coding: utf-8 -*-
"""Bản sao của Exercise 3.5 Create a classification model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15T5LOl9FJZvXZ85KoebE8iWh1CuzXUc8
...
df = pd.read_csv("/content/sample_data/titanic_all_numeric.csv")
...
# Biến cột 'survived' (0 hoặc 1) thành định dạng one-hot encoding
target = to_categorical(df.survived)

# Set up the model
model = Sequential()

# Add the first layer (lớp ẩn)
model.add(Dense(32, activation='relu', input_shape=(n_cols,)))

# Add the output layer (lớp đầu ra)
# - 2 units vì có 2 kết quả (không sống sót, sống sót)
# - 'softmax' activation để chuyển output thành xác suất
model.add(Dense(2, activation='softmax'))

# Compile the model
# Cấu hình quy trình học cho bài toán phân loại
