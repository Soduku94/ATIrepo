# -*- coding: utf-8 -*-
"""Bản sao của Exercise 4.3 Evaluating model accuracy on validation dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13hnGKTMpugmI_zp3a_JlmOhEPJRjhkE7
...
df = pd.read_csv("/content/sample_data/titanic_all_numeric (1).csv")
...
# Compile the model
# Cấu hình quy trình học với optimizer 'adam' và loss function 'categorical_crossentropy'
model.compile(optimizer='adam',
              loss='categorical_crossentropy',
              metrics=['accuracy'])

# Fit the model
# Huấn luyện mô hình, nhưng dành ra 30% dữ liệu để làm "bài kiểm tra thử"
