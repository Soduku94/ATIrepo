# -*- coding: utf-8 -*-
"""Bản sao của Exercise 4.4 Early stopping.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rgGgWeHYaPrOEbMHVbZxksoBgkM23lAF
...
# Theo dõi val_loss và dừng lại nếu nó không cải thiện sau 2 epochs
early_stopping_monitor = EarlyStopping(patience=2)

# Fit the model
# Huấn luyện tối đa 30 epochs, nhưng có thể dừng sớm hơn
