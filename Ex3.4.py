# -*- coding: utf-8 -*-
"""Bản sao của Exercise 3.4 Understanding your classification data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17ROJ_9YtNYSrZfZO0JgF_ob9LQU0orG8
...
# In ra 5 dòng đầu tiên của DataFrame để xem cấu trúc
print("5 dòng đầu tiên của dữ liệu:")
print(df.head())

# In ra bảng thống kê mô tả cho các cột dữ liệu
print("\nBảng thống kê mô tả:")
print(df.describe())