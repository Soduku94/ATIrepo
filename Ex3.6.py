# -*- coding: utf-8 -*-
"""Bản sao của Exercise 3.6 Making predictions.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1d3q87DhhvHUA1Jm1vcaFWgqCJKHAUEVZ
...
# Đưa dữ liệu mới (pred_data) vào mô hình đã được huấn luyện
predictions = model.predict(pred_data)

# Calculate predicted probability of survival: predicted_prob_true
# Lấy ra cột thứ hai (index 1), tương ứng với xác suất "sống sót"
